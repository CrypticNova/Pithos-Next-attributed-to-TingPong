...
**DISCLAMER** This Repo is fully attributed to TingPing's pithos for windows - https://github.com/TingPing/pithos-for-windows          


Installation
-----------
Newest release can be found [here] and read notes below.

64bit users can just download this [zip] though 32bit is recommended as default

See [redist.txt] for optional plugin requirements.
